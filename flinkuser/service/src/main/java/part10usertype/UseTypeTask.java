...
import part09kafkaevent.KafkaEventSchema;
...
public class UseTypeTask {
    public static void main(String[] args) {
        ...
        DataStream<UseTypeEntity> useTypeMap = input.flatMap(new UseTypeMap());

        DataStream<UseTypeEntity> useTypeReduce = useTypeMap.keyBy("groupbyfield").timeWindowAll(Time.seconds(2)).reduce(new UseTypeReduce());
