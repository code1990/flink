 ...
 * @Description:
 */
public class SexPreMap implements MapFunction<String, SexPreEntity> {
    @Override
    public SexPreEntity map(String s) throws Exception {
        ...
        SexPreEntity sexPreInfo = new SexPreEntity();
